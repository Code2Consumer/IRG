    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/messagerie')) {
            ...
            if (rtrim($pathinfo, '/') === '/messagerie') {
                ...
                return array (  '_controller' => 'Acme\\MessagerieBundle\\Controller\\DefaultController::indexAction',  '_route' => 'messagerie_homepage',);
            }

            // nouveau_message
            if ($pathinfo === '/messagerie/corbeau') {
                return array (  '_controller' => 'Acme\\MessagerieBundle\\Controller\\DefaultController::nouveau_messageAction',  '_route' => 'nouveau_message',);
            }

            // lire_message
            if (0 === strpos($pathinfo, '/messagerie/read_message') && preg_match('#^/messagerie/read_message/(?P<id_message>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'lire_message')), array (  '_controller' => 'Acme\\MessagerieBundle\\Controller\\DefaultController::read_messageAction',));
            }

            // repondre
            if (0 === strpos($pathinfo, '/messagerie/corbeau') && preg_match('#^/messagerie/corbeau/(?P<id_destinataire>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'repondre')), array (  '_controller' => 'Acme\\MessagerieBundle\\Controller\\DefaultController::repondreAction',));
            }
