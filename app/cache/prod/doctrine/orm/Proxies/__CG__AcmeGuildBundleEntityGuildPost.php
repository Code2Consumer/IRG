 ...
 */
class GuildPost extends \Acme\GuildBundle\Entity\GuildPost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildPost' . "\0" . 'id', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildPost' . "\0" . 'guildId', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildPost' . "\0" . 'userId', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildPost' . "\0" . 'userName', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildPost' . "\0" . 'date', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildPost' . "\0" . 'message');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GuildPost $proxy) {
