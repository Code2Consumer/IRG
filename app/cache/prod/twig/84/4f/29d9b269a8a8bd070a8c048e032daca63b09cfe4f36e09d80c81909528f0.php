...
";
        // line 40
        if (((isset($context["cand"]) ? $context["cand"] : null) != 0)) {
            // line 41
            echo "
<span id=\"cand-count\"> ";
            // line 42
            echo twig_escape_filter($this->env, (isset($context["cand"]) ? $context["cand"] : null), "html", null, true);
            echo "
</span>
";
        }
...
<a class=\"list-group-item\" href=\" ";
        // line 48
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("guild_membres", array("GuildId" => $this->getAttribute((isset($context["guild"]) ? $context["guild"] : null), "id", array()))), "html", null, true);
        echo "\"> Les membres </a>
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["GuildPost"]) ? $context["GuildPost"] : null)));
