 ...
 */
class Participant extends \Acme\GuildBundle\Entity\Participant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\GuildBundle\\Entity\\Participant' . "\0" . 'id', '' . "\0" . 'Acme\\GuildBundle\\Entity\\Participant' . "\0" . 'eventId', '' . "\0" . 'Acme\\GuildBundle\\Entity\\Participant' . "\0" . 'userId', '' . "\0" . 'Acme\\GuildBundle\\Entity\\Participant' . "\0" . 'userName', '' . "\0" . 'Acme\\GuildBundle\\Entity\\Participant' . "\0" . 'role');
        }
