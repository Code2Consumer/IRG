 ...
 */
class GuildMembres extends \Acme\GuildBundle\Entity\GuildMembres implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildMembres' . "\0" . 'id', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildMembres' . "\0" . 'guildid', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildMembres' . "\0" . 'userid', '' . "\0" . 'Acme\\GuildBundle\\Entity\\GuildMembres' . "\0" . 'username');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GuildMembres $proxy) {
