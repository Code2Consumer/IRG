...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/guild')) {
            ...
            // guild_membres
            if ($pathinfo === '/guild/membres') {
                return array (  '_controller' => 'Acme\\GuildBundle\\Controller\\PublicController::ShowMembresAction',  '_route' => 'guild_membres',);
            }
        ...
        // show_profile
        if ($pathinfo === '/mon-profile') {
            return array (  '_controller' => 'Acme\\UserBundle\\Controller\\PublicController::MonProfileAction',  '_route' => 'show_profile',);
        }
